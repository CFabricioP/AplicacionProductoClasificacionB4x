...
clasificacionesservice.myClass = BA.getDeviceClass ("b4a.example.clasificacionesservice");
productosservice.myClass = BA.getDeviceClass ("b4a.example.productosservice");
clasificacionpage.myClass = BA.getDeviceClass ("b4a.example.clasificacionpage");
productopage.myClass = BA.getDeviceClass ("b4a.example.productopage");
